    ...
    private void runAsyncTask() {
        new AsyncTask<Void, Integer, Boolean>() {
            ...
            protected void onPostExecute(Boolean status) {
                ...
                double cal_StanWeight = 0;
                double cal_BodyFat = 0;
                if (gender == 1) {
                    cal_StanWeight = 22 * cal_Tall / 100 * cal_Tall / 100;
                    cal_BodyFat = (cal_Weight - (0.88 * cal_StanWeight)) / cal_Weight * 100;
                }
                if (gender == 2) {
                    cal_StanWeight = 22 * cal_Tall / 100 * cal_Tall / 100;
                    cal_BodyFat = (cal_Weight - (0.82 * cal_StanWeight)) / cal_Weight * 100;
                }

                standardWeight.setText(String.format("%.2f", cal_StanWeight));
